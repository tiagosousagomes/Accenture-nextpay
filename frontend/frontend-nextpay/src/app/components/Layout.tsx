  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <aside className="w-64 bg-gradient-to-b from-petroleo-900 to-petroleo-950 text-white fixed h-full">
        <div className="p-6">
          <h1 className="text-2xl font-bold">NextPay</h1>
        ...
        <div className="absolute bottom-0 w-64 p-6 border-t border-white/20">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 bg-white/20 flex items-center justify-center overflow-hidden">
              {(user as any)?.fotoPerfilUrl ? (
                <img src={(user as any).fotoPerfilUrl} alt="Perfil" className="w-full h-full object-cover" />
              ) : (
                <User size={20} />
              )}
            </div>
